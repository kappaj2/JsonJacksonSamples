 ...
 * Typically, if you want to print a serialized object, you override the toString() method. 
 * But, by using the@JsonValue annotation, you can define the way in which the Java object is to be serialized.
